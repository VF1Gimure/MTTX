...
from pipelines.models.vit_classifier import ViTClassifier  # Import Vision Transformer model
...
if __name__ == "__main__":
    ...
    # Model Definition
    model = ViTClassifier()
    for param in model.vit.encoder.parameters():  # Freeze encoder layers
        param.requires_grad = False

    for param in model.vit.heads.parameters():  # Unfreeze classifier head
